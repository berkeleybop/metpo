 ...
 * [metpo.yml](metpo.yml)
     * Determines how your purl.obolibrary.org/obo/metpo/ redirects will be handled
     ...
     * Paste in the contents of [metpo.yml](metpo.yml)
 ...
 * [metpo.md](metpo.md)
     ...
     * Paste in the contents of [metpo.md](metpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
