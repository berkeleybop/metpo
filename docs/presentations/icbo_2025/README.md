...
```
docs/presentations/icbo_2025/
├── README.md                           # This file
├── icbo_metpo_slides.md                # Marp slide source
├── icbo_metpo_slides.pdf               # Generated slides
├── Mark-METPO-2025-11-11.pdf           # Final presentation
├── SESSION_LOG.md                      # Session documentation
├── PRESENTATION_NOTES.md               # Speaker notes
├── PRIMARY_SOURCE_ONTOLOGY_ANALYSIS.md # Source analysis
├── ICBO_SLIDES_PREP_SESSION.md         # Prep session notes
...
└── figures/                            # Analysis figures
    ...
    └── metpo_viz/                      # Visualization data
```

## Example Extractions

The example extractions used in this presentation are now integrated into the literature mining pipeline:

- **Inputs**: `../../literature_mining/abstracts/icbo_examples/`
- **Outputs**: `../../literature_mining/outputs/icbo_examples/`
- **Templates**: `../../literature_mining/templates/`
  - `strain_phenotype_icbo.yaml`
  - `chemical_utilization_icbo.yaml`
